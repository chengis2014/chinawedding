                    ...
                    <div id="integralForm">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>积分最小值</label>
                                <input style="width:350px" class="form-control" id="mininum" name="mininum">
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>积分最大值</label>
                                <input style="width:350px" class="form-control" id="maxinum" name="maxinum">
                            </div>
                            <div class="form-group">
                                <label>等级</label>
                                <select style="width:350px" class="form-control" id="grade" name="grade">
