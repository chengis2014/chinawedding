...
<script >
    ...
    function initTable() {
        ...
        $("#cusTable").bootstrapTable({
            ...
            url: "<%=basePath%>/merchant/getSettlementList.do", //获取数据的Servlet地址
            striped: true,  //表格显示条纹
...
<div class=" style_border">
    ...
    <table id="cusTable" class="table">
        ...
        <tr>
            ...
            <th data-field="accountprice" data-editable="false" align="center">抽成金额</th>
            <th data-field="addtime" data-editable="false" align="center">生成时间</th>
            <th data-field="prevture" data-editable="false" align="center">上次交易额</th>
            <th data-field="fcbl" data-editable="false" align="center">分成比例</th>
        </tr>
        </thead>
    </table>
    </div>
